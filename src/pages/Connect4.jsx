...
import '../extraCSS/Connect4.css'
import { blueo, redx } from '../assets';
import c4Gameboard from '../C4components/c4Gameboard.jsx';
  ...
  return (
    <main>
      <div className='mt-10 flex flex-col justify-center items-center px-4'>
        <div className={`bruno-ace-sc-regular text-1xl sm:text-2xl md:text-3xl lg:text-4xl sm:mb-2 md:mb-4 `}>Connect 4</div>
      </div>
