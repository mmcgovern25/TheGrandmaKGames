export default function GameOver({ winner, onRestart }) {
  return (
    <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center bg-[rgba(34,66,34,0.95)] animate-pop-in">
      <h2 className="text-4xl text-center text-[#e1dec7] m-0">Game Over</h2>
      {winner ? (
        <p className="text-2xl mt-2 text-center text-[#e1dec7]">{winner} won!</p>
      ) : (
